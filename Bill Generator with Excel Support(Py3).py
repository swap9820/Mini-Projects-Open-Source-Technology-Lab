...
os.system("title Bill Generator")
...
ctypes.windll.user32.MessageBoxA(0,"Bill Create successfully in a text and Excel file "+filename+"and"+filename+".xlsx","Message",0)
